...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind("FirstMidName,HireDate,LastName,OfficeAssignment")]Instructor instructor,string[] selectedCourses)
        {
        ...
        private void UpdateInstructorCourses(string[] selectedCourses,Instructor instructorToUpdate)
        {
            ...
            foreach(var course in _context.Course)
            {
                ...
                else
                {
                    if(instructorCourses.Contains(course.CourseID))
                    {
                        CourseAssignment courseRemove = instructorToUpdate.CourseAssignments.FirstOrDefault(i => i.CourseID == course.CourseID);
